...
export declare class InteractionsService {
    ...
    subscribeInteractionUpdates(callback: InteractionsServiceTypes.RealTimeCallback): Promise<string>;
    stopInteractionUpdates(subscriptionId: string): Promise<void>;
    startQueuedPolling(callback: InteractionsServiceTypes.PollingCallback, sortBy?: InteractionsServiceTypes.SortBy, filters?: InteractionsServiceTypes.Filters, dateRange?: InteractionsServiceTypes.DateRange): Promise<string>;
    fetchMoreQueuedInteractions(subscriptionId: string): Promise<boolean>;
    fetchQueuedTaskById(taskId: string): Promise<InteractionsServiceTypes.TaskDetails | null>;
