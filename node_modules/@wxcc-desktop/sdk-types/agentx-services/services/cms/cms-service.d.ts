...
export declare function cmsService(): {
    ...
    fetchQueueConfigLimit: (p: {
        orgId: string;
        queueId: string;
    }, cb?: ((res: any) => void | CmsServiceTypes.QueueConfigLimitResponse) | undefined) => Promise<CmsServiceTypes.QueueConfigLimitResponse>;
...
declare module "../../index" {
    namespace Service.Cms {
        ...
        type QueueConfigLimitResponse = CmsServiceTypes.QueueConfigLimitResponse;
