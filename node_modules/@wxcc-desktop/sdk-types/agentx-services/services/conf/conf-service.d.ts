...
export declare class ConfService {
    ...
    getDefaultIdleCode: (idleCodes: Service.Aqm.Configs.Entity[]) => import("../aqm/types/aqm-service-configs.types").Entity | undefined;
    getDefaultWrapUpCode: (wrapUpReasonList: Service.Aqm.Configs.Entity[]) => import("../aqm/types/aqm-service-configs.types").Entity | undefined;
    updateAuxCodeConfig: (idleCodes: Service.Aqm.Configs.Entity[], wrapUpReasonList: Service.Aqm.Configs.Entity[]) => void;
    updateWrapUpCodeConfig: (agentWrapUpCodes: import("../aqm/types/aqm-service-configs.types").AgentWrapUpCodes) => void;
