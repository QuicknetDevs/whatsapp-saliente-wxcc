...
import { AgentPerformanceService } from "./agent-performance/agent-performance-service";
import { absService } from "./agentx-backend-proxy/agentx-backend-proxy-service";
import { ApiAiAssistantService } from "./api-ai-assistant-service/api-ai-assistant-service";
...
import { HangDetectionService } from "./hang-detection/hang-detection-service";
import { MicrosoftService } from "./integration/microsoft/microsoft-authentication";
import { type InteractionsService } from "./interactions";
...
import { WebexCallingService } from "./webex/webex-calling-service";
...
export declare class AgentxServices {
    ...
    webexCalling: WebexCallingService;
    qmw: ReturnType<typeof qmwService>;
    microsoft: MicrosoftService;
    interactions: InteractionsService;
    avatar: AvatarService;
    agentPerformance: AgentPerformanceService;
    apiAIAssistant: ApiAiAssistantService;
    agentService: AgentService;
    tasks: TasksService;
    hangDetection: HangDetectionService;
    i18n: import("i18next").i18n & {
        readonly DEFAULT_INIT_OPTIONS: import("i18next").InitOptions;
    };
    isIniting: boolean;
    isInited: boolean;
    init(token: OAuth.Token, oauthConfig: OAuth.Config): Promise<void>;
}
