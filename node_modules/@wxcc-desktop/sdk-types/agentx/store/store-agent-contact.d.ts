...
export declare class ModuleAgentContact extends OpenTasksStore {
    ...
    getAcceptedTasks: () => {
        ...
        contactAssignmentType?: string | undefined;
    ...
    get contact(): {
        ...
        queueId: string;
        enterpriseId: string;
        chatMessages: import("@/../../agentx-services/dist/types/agentx-services/src/services/cms/types/cms-service.types").ChatTemplateResponse;
    };
    ...
    get isActiveCallNotInWrapUp(): boolean;
    ...
    private readonly getCallIdForTask;
