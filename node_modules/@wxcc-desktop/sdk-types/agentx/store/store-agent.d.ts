...
export declare class ModuleAgent extends UserStore {
    ...
    lcmUrl: string;
    teamUniqueId: string;
    dialPlan: import("@/../../agentx-services/dist/types/agentx-services/src/services/aqm/types/aqm-service-configs.types").DialPlan;
    outDialEp: string;
    ...
    setFilterAgent(agentName: string): void;
}
