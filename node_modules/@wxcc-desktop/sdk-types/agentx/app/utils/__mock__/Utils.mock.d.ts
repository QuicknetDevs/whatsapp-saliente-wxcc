...
export declare const paginatedTeamResponse: {
    data: {
        teamId: string;
        teamName: string;
...
export declare const generatedSummariesResponse: {
    data: {
        organizationId: string;
        id: string;
        version: number;
...
export declare const agentBurnoutResponse: {
    data: {
        organizationId: string;
        id: string;
        version: number;
...
export declare const aiFeatureResponse: {
    meta: {
        orgid: string;
        page: number;
        pageSize: number;
...
export declare const organizationSettingsResponseValidAssistantQuantity: {
    organizationId: string;
    id: string;
    aiAssistantQuantity: number;
}[];
export declare const organizationSettingsResponseInvalidAssistantQuantity: {
    organizationId: string;
    id: string;
    aiAssistantQuantity: number;
}[];
export declare const fakeMediaForkInteraction: {
    isFcManaged: boolean;
    isTerminated: boolean;
    mediaType: string;
    previousVTeams: never[];
    state: string;
    currentVTeam: string;
    participants: string;
