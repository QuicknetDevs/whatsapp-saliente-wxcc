...
export declare const handleCallbackCloseModal: (triggeredFrom: string | undefined) => void;
...
export declare function getVisualRebrandNewLookToggleEnabled(): boolean;
export declare function getVisualRebrandNewLookDefaultEnabled(): boolean;
...
export declare function updateAgentQueueManagementEnabled(): Promise<void>;
